                      ...
                      <div className="flex items-start gap-2 text-amber-300">
                        ...
                        <span className="text-base">
                          {!isSingleAreaProvince
                            ? `โดยทั่วไปแล้ว คุณไม่สามารถเลือกตั้งล่วงหน้าในเขตที่คุณมีสิทธิเลือกตั้งได้ คุณต้องลงทะเบียนเลือกตั้งล่วงหน้า/นอกเขตเท่านั้น`
                            : `โดยทั่วไปแล้ว คุณไม่สามารถเลือกตั้งล่วงหน้าในเขตที่คุณมีสิทธิเลือกตั้งได้ คุณต้องลงทะเบียนเลือกตั้งล่วงหน้า/นอกเขตเท่านั้น และเนื่องจากจังหวัด${votingProvince} มีเขตเลือกตั้งเดียว คุณต้องลงทะเบียนเลือกตั้งล่วงหน้า/นอกเขตที่จังหวัดข้างเคียง`}
                        </span>
                      </div>
                    </div>
                  )}
